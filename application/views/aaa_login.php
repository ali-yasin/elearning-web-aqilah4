...
<meta name="description" content="Elearning - SMK Insan Aqilah 4">
...
<div class="container">
	...
	<form action="" method="post" name="fl" id="f_login" onsubmit="return login();">
		<div class="panel panel-default top150">
			<div class="panel-heading"><h4 style="margin: 5px"></i>SMK Insan Aqilah 4</h4></div>
			<div class="panel-body">
				...
				<div class="login-actions">
					<button class="btn btn-success btn-sm tombol-kanan btn-large col-lg-12 top15">Login elearning</button>
